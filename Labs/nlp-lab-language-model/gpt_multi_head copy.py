...
class Block(nn.Module):
    ...
    def __init__(self, n_embd, n_head):
        ...
        self.ln1 = nn.LayerNorm(n_embd)  # LayerNorm before MultiHeadAttention
        self.ln2 = nn.LayerNorm(n_embd)  # LayerNorm before FeedForward

    def forward(self, x):
        x = x + self.sa(self.ln1(x))  # Skip connection and LayerNorm 1
        x = x + self.ffwd(self.ln2(x)) # Skip connection and LayerNorm 2
        return x
...
class BigramLanguageModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.blocks = nn.Sequential(OrderedDict([
            ('block1', Block(n_embd, n_head=4)),
            ('block2', Block(n_embd, n_head=4)),
            ('block3', Block(n_embd, n_head=4)),
        ]))
